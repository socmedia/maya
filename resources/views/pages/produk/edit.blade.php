                            ...
                            <fieldset class="form-group row">
                                <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                                    ...
                                    <input type="number"
                                        ...
                                        name="production" value="{{$product->production_price}}" min="1">
                                    @error('production')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                                    ...
                                    <input type="number" class="form-control @error('sell') {{'is-invalid'}} @enderror"
                                        name="sell" value="{{$product->sell_price}}" min="1">
                                    @error('sell')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="icheck-primary mr-2">
                                            <input type="radio" id="radioPrimary2" name="is_showed" value="0"
                                                {{$product->is_showed === 0 ? 'checked' : ''}}>
                                            <label for="radioPrimary2">
                                                Sembunyikan
                                            </label>
                                        </div>
                                        <div class="icheck-primary">
                                            <input type="radio" id="radioPrimary1" name="is_showed" value="1"
                                                {{$product->is_showed === 1 ? 'checked' : ''}}>
